...
| substrate-check (`bench/substrate-check.sh`) | **adopted** | makes "model-independent harness" a measurement (before/after delta 0), not a claim; complements bench/ (bench = style transfer, substrate-check = gate invariance) |
